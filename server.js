...
// A new, empty database has no admin to sign in with, so nobody could press
// «Загрузить данные из Supabase». With the Supabase keys in .env it loads by
// itself instead; after an error it tries again at the next start.
importIfEmpty().catch((e) => console.error('[import] startup load failed:', e.message));
